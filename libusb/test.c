...
#define USB_VENDOR_ID	    0x3036      /* USB vendor ID used by the device
                                         * 0x0483 is STMs ID
                                         */
#define USB_PRODUCT_ID	    0x0052      /* USB product ID used by the device */
...
#define USB_ENDPOINT_IN	    0x0081
#define USB_ENDPOINT_OUT	0x0001
